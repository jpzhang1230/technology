...
public class RecordWriter {
	...
	static{
		...
		try {
			archiveFactory.put("binary", BinaryOutputArchive.class.getDeclaredMethod(
					"getArchive", params));
			archiveFactory.put("xml", XmlOutputArchive.class.getDeclaredMethod(
					"getArchive", params));
	...
	/**
	 * @param format in ("xml","binary") 
	 * @return
	 */
	public static  OutputArchive createArchive(OutputStream out, String format)
			throws IOException {
